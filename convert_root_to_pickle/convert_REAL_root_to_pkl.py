...
def readEPGG(tree, entry_stop = None):
    ...
    eleKeysRec = ["Epx", "Epy", "Epz",'helicity','EventNum','RunNum','beamQ']
...
if __name__ == "__main__":
    ...
    dirname = "/mnt/d/GLOBUS/CLAS12/real_data/F18_Inbending_FD_SangbaekSkim_0_20210205/raw_root/"
    #out_dirname = "/mnt/d/GLOBUS/CLAS12/real_data/F18_Inbending_FD_SangbaekSkim_0_20210205/no_cuts_at_all/"
    #out_dirname = "/mnt/d/GLOBUS/CLAS12/real_data/F18_Inbending_FD_SangbaekSkim_0_20210205/no_cuts_at_all/"

    file_list = os.listdir(dirname)

    #file_list = ["skim8_005346_filtered.root"]
    failcount = 0
    for filename in file_list:
        args.fname = dirname+filename
        args.out = out_dirname+filename.split(".roo")[0]+".pkl"
        print("\n\n Working on file: {} \n\n".format(filename))
        print(args.fname)
        print(args.out)
        ...
        try:
            ...
            ic(df_real)
            df_real.to_pickle(args.out)
            ic(df_real.columns.values)
        except:
            print("that didn't work for filename: ")
            print(filename)
            failcount += 1
