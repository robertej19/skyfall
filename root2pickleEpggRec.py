...
class root2pickle():
    ...
    def __init__(self, fname, entry_stop = None, pol = "inbending"):
        self.fname = fname
        self.readEPGG(entry_stop, pol = pol) #good 
        self.saveDVpi0vars() #good
        self.makeDVpi0()
        self.saveRaw()
    ...
    def readEPGG(self, entry_stop = None, pol = "inbending"):
        ...
        VGS = [-df_electronGen['GenEpx'], -df_electronGen['GenEpy'], pbeam - df_electronGen['GenEpz']]
        Genele = [df_electronGen['GenEpx'], df_electronGen['GenEpy'], df_electronGen['GenEpz']]
        df_electronGen.loc[:, 'GenEe'] = getEnergy(Genele, me)
        df_electronGen.loc[:,'GenW1'] = np.sqrt(np.maximum(0, (ebeam + M - df_electronGen['GenEe'])**2 - mag2(VGS)))
...
if __name__ == "__main__":
    ...
    args.fname = "/mnt/d/GLOBUS/CLAS12/simulations/W_LessThan_1900MeV_norad/4_Final_Output_Files/Fall_2018_Inbending/Raw_Root_Files/Norad/Recon/merged_Fall_2018_Inbending_recon.root"
